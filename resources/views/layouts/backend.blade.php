...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click"
    ...
    <script src="{{ asset('backend/vendors/js/extensions/sweetalert.min.js') }}"" type="text/javascript"></script>
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/css/extensions/sweetalert.css') }}">
