...
<html lang="ar">
    <head>
        ...
        >
        <link rel="stylesheet" href="{{ asset('front/libs/fontawesome-pro-5.14.0/fontawesome-pro-5.14.0-web/css/all.min.css') }}">
        ...
        .navbar-custom {
      background-color: rgb(66, 182, 197); /* Light pink background */
      color: #333;
      border-radius: 10px;
    ...
    <body dir="rtl">
        <nav class="navbar navbar-expand-lg navbar-custom">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('front/images/logo2.png')}}" alt="Logo">
...
<footer class="bg-info text-white pt-4">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="images/logo2.png" width="200px" alt="Logo" class="img-fluid mb-2">
            </div>
            <div class="col-md-4">
                <h4>Useful Links</h4>
