                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('products.update',$product->id) }}"
                                    ...
                                    <div class="form-body  ">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 ">
                                                <label class="label-control" for="projectinput1"> صورة الرئيسية للمنتج </label>
                                                <input type="file"  name="image" class="form-control image"
                                                    id="">
                                                <div class="mr-4">
                                                    <img src="{{ asset('uploads/'.$product->thump_image) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 ">
                                                ...
                                                <select name="sub_category_id" id="sub_category_id" class="form-control"
                                                    required>
                                                    @foreach (App\Models\Category::where('parent_id',$product->category_id)->get() as $item)
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 ">
                                                ...
                                                <input type="number" value="{{ $product->discount }}" min="0" required name="discount"
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="form-group col-md-6 ">
                                                <div class="row">
                                                    ...
                                                    foreach ($product->atts as $key => $att) {
                                                            array_push($colors,$att->color);
                                                            array_push($sizes,$att->size);
                                                    }
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <select class="form-control color0 " name="colors[]"
                                                            ...
                                                            @foreach (App\Models\Color::get() as $item)
                                                                <option value="{{ $item->name }}" @if(in_array($item->name,$colors)) selected @endif
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <select class="form-control size0 " name="sizes[]"
                                                            ...
                                                            <option value="{{ $item->name }}" @if(in_array($item->name,$sizes)) selected @endif
                                                                >
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                        </select>
                                        ...
                                        <div class="row" id="generated_inputs">
                                            ...
                                            <div class="form-group col-md-3 ">
                                                <label class="label-control" for="projectinput1"><span style="color:` + color + `"> اللون  {{ $item->color }}
                                                                    الحجم {{ $item->size }}</span> </label>
                                                <input type="text" required="" readonly value="{{ $item->all_attr }}" name="color_size[{{ $key }}]" class="form-control" id="">  
                                                </div>
                                                <div class="form-group col-md-3 ">
                                                <label class="label-control" for="projectinput1"><span class="required"></span> قيمة المخزون </label>
                                                <input type="number" min="0" required="" value="{{ $item->storage }}" name="color_storege[{{  $key }}]" class="form-control" id="">  
                                                </div> 
                                            @endforeach
