                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('categories.update',$cat->id) }}"
                                    ...
                                    <div class="form-body  ">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 ">
                                                ...
                                                <input type="text" value="{{ $cat->name }}" required name="name" class="form-control"
                                                    id="">
                                    ...
                                    <div class="form-body">
                                        {{-- <h4 class="form-section"><i class="ft-user"></i> فئة فرعية ام لا  </h4> --}}
                                        <div class="row">
                                            <div class="form-group col-md-6 " style="display: none" >
                                               ...
                                               <select name="is_parent" required class="form-control" id="is_parent">
                                                ...
                                                <option value="1" @if($cat->is_parent == 1 ) selected @endif>فئة فرعية</option>
                                                <option value="0" @if($cat->is_parent == 0 ) selected @endif>فئة رئيسية</option>

                                               </select>

                                            </div>
                                            <div class="form-group col-md-6 " id="main_cats"  style="display: @if($cat->is_parent == 0) none @else block @endif"  >
                                                <label class="label-control" for="projectinput1"> فئة فرعية تابعة ل     </label>
                                                <select name="parent_id" @if($cat->is_parent == 1) required @endif  class="form-control" id="parent_id">
                                                    <option value="" selected disabled>اختيار</option>
                                                    @foreach ($categories as $item)
                                                    <option value="{{ $item->id }}" @if($cat->parent_id == $item->id ) selected @endif>{{ $item->name }} </option>
                                                    @endforeach
