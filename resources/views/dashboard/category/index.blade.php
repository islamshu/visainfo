                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <a class="btn btn-success" href="{{ route('categories.create') }}">اضف صنف جديد</a>
                                    <br>
                                            ...
                                            @foreach ($categories as $key => $item)
                                                <tr >
                                                    ...
                                                    <td>
                                                      ...
                                                      <td>
                                                      @if($item->is_parent == 0 && App\Models\Category::where('parent_id',$item->id)->count() > 0)
                                                        <a href="{{ route('sub_index',['parent_id'=>$item->id]) }}" class="btn btn-dark">الفئات الفرعية</a>
                                                        @else
                                                        _ @endif
                                                      </td>
